...
class MainPage extends StatefulWidget {
  ...
  const MainPage({required this.data, Key? key}) : super(key: key);
...
class _MainPageState extends State<MainPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Model> models = [
      Model("open native test page", () {
        BoostNavigator.instance.push("testPage", arguments: {
          'data': _controller.text
        }).then((value) => showTipIfNeeded(value.toString()));
      }),
      Model("open native RN page", () {
        BoostNavigator.instance.push("rnPage", arguments: {
          'data': _controller.text
        }).then((value) => showTipIfNeeded(value.toString()));
      }),
